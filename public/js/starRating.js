...
document.getElementsByClassName(className)[i].parentElement.addEventListener("touchstart", function(){ zmouseMoveStarRatingTouch(fncMove) },{passive: true}, {capture: false});
...
document.getElementsByClassName(className)[i].parentElement.addEventListener("touchmove", function(){zmouseMoveStarRatingTouchMove(fncMove)},{passive: true}, {capture: false});
}
